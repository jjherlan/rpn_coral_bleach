...
<!-- #ggtitle(expression(paste(italic(" Porites "), "spp."))) + --> <!-- #geom_text(aes(label = cld, y = upper.ci), vjust = -0.5, size = 10) + --> <!-- #scale_y_log10(expression(paste("Colony Size (", cm^2, ")"), limits = c(0, 100000))) + -->
